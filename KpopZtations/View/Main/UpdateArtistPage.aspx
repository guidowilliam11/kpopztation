<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/Main.Master" AutoEventWireup="true" CodeBehind="UpdateArtistPage.aspx.cs" Inherits="KpopZtations.View.Main.UpdateArtistPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AuthForm" runat="server">
    <div class="flex flex-col gap-5 p-24 w-2/3 shadow my-5 mx-auto">
        <h1 class="text-4xl font-bold text-dBlue text-center">Update Artist</h1>
        ...
        <div class="flex flex-col gap-3">
            <asp:Button ID="updateBtn" runat="server" Text="Insert Artist" class="text-dPink font-medium border-2 border-dPink px-6 py-2 rounded-full hover:bg-dPink hover:text-white"  OnClick="updateBtn_Click" />
        </div>
    </div>
    <script>
