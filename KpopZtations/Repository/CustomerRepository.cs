...
namespace KpopZtations.Repository
{
    public class CustomerRepository
    {
        ...
        public void update(int id, String customerName, String customerEmail, String customerPassword, String customerGender, String customerAddress, String customerRole)
        {
            Customer c = search(id);
            c.CustomerName = customerName;
            c.CustomerEmail = customerEmail;
